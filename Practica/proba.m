...
for i = 1:numImages
    ...
    Features(i, :) = [compacitat, solidesa, extent, ecc, pct_red, pct_blue, pct_yellow];
end
...
TaulaFinal.Properties.VariableNames{3} = 'Extenció';
TaulaFinal.Properties.VariableNames{4} = 'Excentricitat';
